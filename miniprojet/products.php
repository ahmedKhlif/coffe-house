...
<div class="container box-container">
    ...
    while($row = mysqli_fetch_array($result)){
                ...
                <div class='box'>
                            ...
                            <h3>".$row['name']."</h3>
                            <p>".$row['price']. ' dt'."</p>
                            <a href='cart_add.php?id=".$row['id']."' class='btn btn-block btn-primary link-btn' name='add' value='add' class='btn btn-block btr-primary'>Add to cart</a> </div>
                                    ";
      } }
                                   else  {
                                      while($row = mysqli_fetch_array($result)){
                                                  ...
                                                  <div class='box'>
                                                              ...
                                                              <h3>".$row['name']."</h3>
                                                              <p>".$row['price'].' dt'."</p>
                                                              <a  href='login.php'class='btn btn-block btn-primary link-btn' >Buy Now</a>
                                                              </div>
